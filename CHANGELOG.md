...
- Write stdout logs through a non-blocking appender (`lossy(false)`, nothing dropped), taking the pipe write off the block executor's path [#7303](https://github.com/lambdaclass/ethrex/pull/7303)
