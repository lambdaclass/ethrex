...
- Journal the substate for O(1) call-frame commits, and key the warmth/storage maps by truncation instead of fxhash [#7124](https://github.com/lambdaclass/ethrex/pull/7124)
