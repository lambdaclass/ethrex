...
pub static BPO2_CONFIG: LazyLock<ChainConfig> = LazyLock::new(|| ChainConfig {
    bpo1_time: Some(0),
    bpo2_time: Some(0),
    ..*OSAKA_CONFIG
});

pub static BPO2_TO_AMSTERDAM_AT_15K_CONFIG: LazyLock<ChainConfig> = LazyLock::new(|| ChainConfig {
    amsterdam_time: Some(0x3a98),
    ..*BPO2_CONFIG
});

pub static AMSTERDAM_CONFIG: LazyLock<ChainConfig> = LazyLock::new(|| ChainConfig {
