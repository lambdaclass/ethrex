...
pub fn parse_and_execute(
    ...
    let fusaka_eips_to_test: Vec<&str> =
        vec!["eip-7883", "eip-7939", "eip-7951", "eip-7594", "eip-7825"];
...
fn exception_is_expected(
    ...
    expected_exceptions.iter().any(|exception| {
        if let (
            ...
            | ChainError::InvalidTransaction(error_msg),
...
fn match_alternative_revm_exception_msg(expected_msg: &String, msg: &str) -> bool {
    matches!(
        ...
        || (msg.starts_with("Gas allowance exceeded.") && expected_msg == "Gas allowance exceeded")
}
