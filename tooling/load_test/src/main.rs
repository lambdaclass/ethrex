...
const ERC20: &str = include_str!("../../../test_data/fixtures/contracts/ERC20/ERC20.bin/TestToken.bin").trim_ascii();
...
// See `test_data/fixtures/contracts/load_test/IOHeavyContract.sol` for the code.
