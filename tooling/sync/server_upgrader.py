...
class StatusEnum(enum.Enum):
    SUCCESS = 0
    FAILED_STOPPED_GENERATING_BLOCKS = 2
    FAILED_STOPPED_RUNNING = 3
    FAILED_SYNC = 3
    ...
    while True:
        ...
        try:
            ...
            if int(result, 0) > current_block_number:
                ...
                return StatusEnum.FAILED_STOPPED_GENERATING_BLOCKS
        except Exception as e:
            return StatusEnum.FAILED_STOPPED_RUNNING
...
def main():
    ...
    try:
        ...
        print(success)
        command = ["make", "server-sync-relaunch"]
