...
```bash
cargo run --bin ethrex -- --network ./test_data/fixtures/genesis/kurtosis.json --bootnodes=`NODE_A_ENODE` \
...
```bash
cargo run --bin ethrex -- --network ./test_data/fixtures/genesis/kurtosis.json --bootnodes=`NODE_B_ENODE` \
