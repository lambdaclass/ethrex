...
mod tests {
    ...
    async fn discovery_server_lookup() -> Result<(), DiscoveryError> {
        let mut server_a = start_discovery_server(8000, true, "ethrex".to_string()).await?;
        let mut server_b = start_discovery_server(8001, true, "ethrex".to_string()).await?;
    ...
    async fn discovery_server_recursive_lookup() -> Result<(), DiscoveryError> {
        let mut server_a = start_discovery_server(8002, true, "ethrex".to_string()).await?;
        let mut server_b = start_discovery_server(8003, true, "ethrex".to_string()).await?;
        let mut server_c = start_discovery_server(8004, true, "ethrex".to_string()).await?;
        let mut server_d = start_discovery_server(8005, true, "ethrex".to_string()).await?;
