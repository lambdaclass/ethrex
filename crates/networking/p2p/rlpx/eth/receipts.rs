...
mod tests {
    ...
    use ethrex_common::types::{Log, Receipt, TxType};
    ...
    fn receipts_versions_have_same_message_code() {
        // All three receipt message types use 0x10; dispatched by eth version
    ...
    fn get_receipts70_wire_format_differs_from_legacy() {
        ...
        // Even with firstBlockReceiptIndex=0, the formats differ because
        // v70 has an extra RLP field
        assert_ne!(buf_legacy, buf_v70);
    }

    #[test]
    fn receipts70_wire_format_differs_from_69() {
        // Same receipts, but eth/70 includes lastBlockIncomplete flag
        ...
        // Formats differ because v70 has the lastBlockIncomplete field
    ...
    fn receipts70_cannot_decode_as_69() {
        // Encoding a Receipts70 and trying to decode as Receipts69
        // should fail because of the extra lastBlockIncomplete field
