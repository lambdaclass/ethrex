...
impl<'a> VM<'a> {
    ...
    pub(crate) fn setup_opcode_table(&mut self) {
        ...
        opcode_table[Opcode::DUP1 as usize] = OpCodeFn(VM::op_swap::<1>);
        opcode_table[Opcode::DUP2 as usize] = OpCodeFn(VM::op_swap::<2>);
        opcode_table[Opcode::DUP3 as usize] = OpCodeFn(VM::op_swap::<3>);
        opcode_table[Opcode::DUP4 as usize] = OpCodeFn(VM::op_swap::<4>);
        opcode_table[Opcode::DUP5 as usize] = OpCodeFn(VM::op_swap::<5>);
        opcode_table[Opcode::DUP6 as usize] = OpCodeFn(VM::op_swap::<6>);
        opcode_table[Opcode::DUP7 as usize] = OpCodeFn(VM::op_swap::<7>);
        opcode_table[Opcode::DUP8 as usize] = OpCodeFn(VM::op_swap::<8>);
        opcode_table[Opcode::DUP9 as usize] = OpCodeFn(VM::op_swap::<9>);
        opcode_table[Opcode::DUP10 as usize] = OpCodeFn(VM::op_swap::<10>);
        opcode_table[Opcode::DUP11 as usize] = OpCodeFn(VM::op_swap::<11>);
        opcode_table[Opcode::DUP12 as usize] = OpCodeFn(VM::op_swap::<12>);
        opcode_table[Opcode::DUP13 as usize] = OpCodeFn(VM::op_swap::<13>);
        opcode_table[Opcode::DUP14 as usize] = OpCodeFn(VM::op_swap::<14>);
        opcode_table[Opcode::DUP15 as usize] = OpCodeFn(VM::op_swap::<15>);
        opcode_table[Opcode::DUP16 as usize] = OpCodeFn(VM::op_swap::<16>);
        opcode_table[Opcode::SWAP1 as usize] = OpCodeFn(VM::op_dup::<1>);
        opcode_table[Opcode::SWAP2 as usize] = OpCodeFn(VM::op_dup::<2>);
        opcode_table[Opcode::SWAP3 as usize] = OpCodeFn(VM::op_dup::<3>);
        opcode_table[Opcode::SWAP4 as usize] = OpCodeFn(VM::op_dup::<4>);
        opcode_table[Opcode::SWAP5 as usize] = OpCodeFn(VM::op_dup::<5>);
        opcode_table[Opcode::SWAP6 as usize] = OpCodeFn(VM::op_dup::<6>);
        opcode_table[Opcode::SWAP7 as usize] = OpCodeFn(VM::op_dup::<7>);
        opcode_table[Opcode::SWAP8 as usize] = OpCodeFn(VM::op_dup::<8>);
        opcode_table[Opcode::SWAP9 as usize] = OpCodeFn(VM::op_dup::<9>);
        opcode_table[Opcode::SWAP10 as usize] = OpCodeFn(VM::op_dup::<10>);
        opcode_table[Opcode::SWAP11 as usize] = OpCodeFn(VM::op_dup::<11>);
        opcode_table[Opcode::SWAP12 as usize] = OpCodeFn(VM::op_dup::<12>);
        opcode_table[Opcode::SWAP13 as usize] = OpCodeFn(VM::op_dup::<13>);
        opcode_table[Opcode::SWAP14 as usize] = OpCodeFn(VM::op_dup::<14>);
        opcode_table[Opcode::SWAP15 as usize] = OpCodeFn(VM::op_dup::<15>);
        opcode_table[Opcode::SWAP16 as usize] = OpCodeFn(VM::op_dup::<16>);
