...
mod tests {
    ...
    fn test_ec_pairing(calldata: &str, expected_output: &str, mut gas: u64) {
        ...
        let expected_output = Bytes::from(hex_simd::decode_to_vec(expected_output).unwrap());
    ...
    fn test_ec_pairing_coordinate_out_of_bounds() {
        let calldata = Bytes::from(hex_simd::decode_to_vec("").unwrap());
