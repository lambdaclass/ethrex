...
impl LEVM {
    ...
    pub fn execute_tx_for_simulation(
        ...
        // No stateless validator: simulation answers a query and produces no
        // EIP-8025 execution proof, matching every other simulation and tracing path.
        let mut vm = VM::new(
            env,
            db,
            tx,
...
pub(crate) fn env_from_generic(
    ...
    Ok(Environment {
        ...
        // The eth_call family keeps enforcing EIP-3607 and emits no traceTransfers
        // logs; both relaxations exist for `eth_simulateV1`, which builds its
        // environment through `setup_env` and opts in there.
        disable_eoa_check: false,
        trace_eth_transfers: false,
