...
/// Embedded BSC mainnet genesis JSON.
const MAINNET_GENESIS_CONTENTS: &str = include_str!("../allocs/mainnet_genesis.json");
...
/// Returns the Genesis for BSC mainnet (chain ID 56).
pub fn bsc_mainnet_genesis() -> Genesis {
    serde_json::from_str(MAINNET_GENESIS_CONTENTS).expect("mainnet genesis should be valid JSON")
}
