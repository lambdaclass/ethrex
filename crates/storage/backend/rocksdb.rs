...
impl RocksDBBackend {
    pub fn open(path: impl AsRef<Path>) -> Result<Self, StoreError> {
        ...
        // Create a shared block cache for all column families (4GB)
        // This is a major optimization: instead of each CF having its own small cache,
        // all CFs share a large unified cache, improving hit rates significantly
        let shared_block_cache = Cache::new_lru_cache(4 * 1024 * 1024 * 1024);
