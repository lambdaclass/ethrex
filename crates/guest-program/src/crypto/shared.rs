...
// sp1-crypto, risc0-crypto, or zisk-crypto is enabled. The openvm-crypto feature
// only provides k256 and does not need BN254 via substrate-bn.
#[cfg(any(feature = "sp1-crypto", feature = "risc0-crypto", feature = "zisk-crypto"))]
