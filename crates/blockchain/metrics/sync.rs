...
impl MetricsSync {
    pub fn new() -> Self {
        MetricsSync {
            ...
            pivot_updates: IntCounterVec::new(
                Opts::new(
            ...
            storage_requests: IntCounterVec::new(
                Opts::new(
            ...
            header_resolution: IntCounterVec::new(
                Opts::new(
    ...
    pub fn gather_metrics(&self) -> Result<String, MetricsError> {
        ...
        r.register(Box::new(self.eligible_peers.clone()))
            .map_err(|e| MetricsError::PrometheusErr(e.to_string()))?;
        r.register(Box::new(self.snap_peers.clone()))
            .map_err(|e| MetricsError::PrometheusErr(e.to_string()))?;
        r.register(Box::new(self.inflight_requests.clone()))
            .map_err(|e| MetricsError::PrometheusErr(e.to_string()))?;
        r.register(Box::new(self.pivot_age_seconds.clone()))
            .map_err(|e| MetricsError::PrometheusErr(e.to_string()))?;
        r.register(Box::new(self.current_phase.clone()))
            .map_err(|e| MetricsError::PrometheusErr(e.to_string()))?;
        r.register(Box::new(self.pivot_updates.clone()))
            .map_err(|e| MetricsError::PrometheusErr(e.to_string()))?;
        r.register(Box::new(self.storage_requests.clone()))
            .map_err(|e| MetricsError::PrometheusErr(e.to_string()))?;
        r.register(Box::new(self.header_resolution.clone()))
            .map_err(|e| MetricsError::PrometheusErr(e.to_string()))?;
