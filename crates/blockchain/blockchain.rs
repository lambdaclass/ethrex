...
impl Blockchain {
    ...
    /// Admit a blob-carrying transaction together with its sidecar, checking that
    /// the transaction is valid. Takes any `Transaction` that declares blobs,
    /// since EIP-4844 and EIP-8141 frame transactions both do.
    ///
