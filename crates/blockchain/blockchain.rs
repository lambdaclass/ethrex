...
/// Merkle write set driving the trie-node prefetch: written storage slots
/// paired with the accounts whose state changed.
#[cfg(all(feature = "rayon", not(feature = "eip-8025")))]
type MerkleWriteSet = (Vec<(Address, H256)>, Vec<Address>);
...
impl Blockchain {
    ...
    fn execute_block_pipeline(
        ...
        #[cfg(all(feature = "rayon", not(feature = "eip-8025")))]
        let trie_prefetch_input: Option<MerkleWriteSet> = if self.options.bal_prefetch_enabled
