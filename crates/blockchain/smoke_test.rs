...
mod blockchain_integration_test {
    ...
    async fn test_small_to_long_reorg() {
        ...
        blockchain.add_block(&block_1a, None).await.unwrap();
        store
    ...
    async fn test_sync_not_supported_yet() {
        ...
        blockchain.add_block(&block_1, None).await.unwrap();
        ...
        let hash_2 = block_2.hash();
        let result = blockchain.add_block(&block_2, None).await;
