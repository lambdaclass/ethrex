...
mod blockchain_integration_test {
    ...
    fn test_small_to_long_reorg() {
        ...
        blockchain.add_block(&block_1a, false).unwrap();
    ...
    fn test_sync_not_supported_yet() {
        ...
        blockchain.add_block(&block_1, false).unwrap();
        ...
        let result = blockchain.add_block(&block_2, false);
