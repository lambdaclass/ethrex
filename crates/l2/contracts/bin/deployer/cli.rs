...
pub struct DeployerOptions {
    ...
    #[arg(
        long,
        default_value_t = format!("{}/../prover/src/guest_program/src/sp1/out/riscv32im-succinct-zkvm-vk", env!("CARGO_MANIFEST_DIR")),
        value_name = "PATH",
    ...
    #[arg(
        long,
        default_value_t = format!("{}/../prover/src/guest_program/src/risc0/out/riscv32im-risc0-vk", env!("CARGO_MANIFEST_DIR")),
        value_name = "PATH",
