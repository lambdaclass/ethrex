...
/// Bytecode of the SP1VerifierGroth16 contract.
/// This is generated by the [build script](./build.rs).
const SP1_VERIFIER_BYTECODE: &[u8] = include_bytes!(concat!(
    env!("OUT_DIR"),
    "/contracts/solc_out/SP1VerifierGroth16.bytecode"
));
...
async fn deploy_contracts(
    ...
    let sequencer_registry_deployment = if opts.deploy_based_contracts {
        ...
        let sequencer_registry_deployment = deploy_with_proxy(
            opts.private_key,
            eth_client,
            SEQUENCER_REGISTRY_BYTECODE.to_vec(),
            &salt,
        )
        .await?;
