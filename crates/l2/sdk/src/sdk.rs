...
// 0x7e bc 60 25 65 9c a5 bd 7c a0 84 0c 69 82 7d 59 2f e9 b5 66
pub const DEFAULT_BRIDGE_ADDRESS: Address = H160([
    0x7e, 0xbc, 0x60, 0x25, 0x65, 0x9c, 0xa5, 0xbd, 0x7c, 0xa0, 0x84, 0x0c, 0x69, 0x82, 0x7d, 0x59,
    0x2f, 0xe9, 0xb5, 0x66,
]);
...
pub const REGISTER_FEE_TOKEN_SIGNATURE: &str = "registerFeeToken(address)";
...
/// BRIDGE_ADDRESS or 0x7ebc6025659ca5bd7ca0840c69827d592fe9b566
...
pub async fn register_fee_token(
    ...
    let tx_register = build_generic_tx(
        ...
        TxType::EIP1559,
        bridge_address()
            .map_err(|e| EthClientError::Custom(format!("failed to get bridge address: {e:?}")))?,
        signer.address(),
        calldata.into(),
        Overrides::default(),
    )
