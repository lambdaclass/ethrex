...
In addition to the components outlined in the [ethrex-L2-Contracts documentation](../../docs/contracts.md), the `based` feature introduces new components to enable decentralized L2 sequencing. These additions enhance the system's ability to operate across multiple nodes, ensuring resilience, scalability, and state consistency.
