/// Circuit Breaker integration with the Phylax Credible Layer.
///
...
///
/// The integration is opt-in via the `--circuit-breaker-url` CLI flag.
/// When disabled, there is zero overhead.
pub mod client;
pub mod aeges;
pub mod errors;

pub use client::CircuitBreakerClient;
