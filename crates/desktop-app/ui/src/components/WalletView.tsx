...
interface DelegationLevelSelectorProps {
  ko: boolean
  level: DelegationLevel
  levelIdx: number
  pendingFull: boolean
...
function DelegationLevelSelector({ ko, level, levelIdx, pendingFull, savedLevel, onSelectLevel }: DelegationLevelSelectorProps) {
...
interface FullDelegationSetupProps {
  ko: boolean
  pendingFull: boolean
...
function PermissionsList({ ko, savedLevel, pendingFull }: PermissionsListProps) {
