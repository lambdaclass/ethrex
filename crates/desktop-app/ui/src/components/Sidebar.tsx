...
const navItems: { view: ViewType; labelKey: string; icon: React.JSX.Element }[] = [
  ...
  {
    view: 'wallet', labelKey: 'nav.delegation',
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a4 4 0 0 0-4 4v2H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2h-2V6a4 4 0 0 0-4-4z"/><circle cx="12" cy="15" r="2"/></svg>,
  },
  {
...
export default function Sidebar({ activeView, onNavigate }: SidebarProps) {
  ...
  return (
    <div className="w-[64px] bg-[var(--color-bg-sidebar)] flex flex-col items-center py-3 border-r border-[var(--color-border)]">
      <button
        onClick={() => onNavigate('home')}
        className="mb-6 w-10 h-10 rounded-full bg-[var(--color-accent)] flex items-center justify-center text-sm font-bold text-[var(--color-accent-text)] cursor-pointer hover:shadow-md transition-shadow"
      >T</button>
      ...
      <div className="mt-auto">
        <div className="w-9 h-9 rounded-full bg-[var(--color-border)] flex items-center justify-center">
