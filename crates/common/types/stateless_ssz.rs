//! SSZ containers for stateless validation (EIP-8025 + Native Rollups).
//!
...
//! execution proofs. Additionally defines `StatelessInput` and
//! `StatelessValidationResult` from the execution-specs `projects/zkevm`
//! branch for use with `verify_stateless_new_payload`.
