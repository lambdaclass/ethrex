        ...
        let vk_path = {
            let path = match &prover_type {
                ProverType::RISC0 => format!(
                    "{}/../../crates/ethrex-guest/bin/risc0/out/riscv32im-risc0-vk",
                ...
                ProverType::SP1 if opts.aligned => format!(
                    "{}/../../crates/ethrex-guest/bin/sp1/out/riscv32im-succinct-zkvm-vk-u32",
                    env!("CARGO_MANIFEST_DIR")
                ),
                ProverType::SP1 if !opts.aligned => format!(
                    "{}/../../crates/ethrex-guest/bin/sp1/out/riscv32im-succinct-zkvm-vk-bn254",
                    env!("CARGO_MANIFEST_DIR")
                ),
