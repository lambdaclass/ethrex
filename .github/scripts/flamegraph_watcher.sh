...
start_time=$(date +%s)
cargo run --release --bin loadtest --manifest-path cmd/ethrex_l2/Cargo.toml -- --path /home/runner/work/ethrex/ethrex/test_data/private_keys.txt -i $iterations -v --value $value --to $account >/dev/null
