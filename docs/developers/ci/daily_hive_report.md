...
- In the CI we run a pinned version of hive (see this [link](https://github.com/lambdaclass/ethrex/blob/9feefd2e3fd2e8bb2097e5e39e0d20f7315c5880/.github/workflows/pr-main_l1.yaml#L259)) whereas in the daily report we run the latest master branch. This is because we prioritize stability on the CI workflow, while the daily report aims to provide more up-to-date simulation resultst.
