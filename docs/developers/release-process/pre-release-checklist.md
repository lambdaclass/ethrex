...
- **ethrex --dev**: Start the container in dev mode and interact via exposed ports (e.g., RPC on 8545).
...
| Target Arch          | Snapsync Hoodi | ethrex --dev |
|--------------------|----------------|--------------|
| macos-aarch64     |                |              |
| linux-aarch64     |                |              |
| linux-x86_64      |                |              |
...
| Target Arch          | Snapsync Hoodi | ethrex --dev | L2 Integration Tests |
|--------------------|----------------|--------------|----------------------|
| macos-aarch64     |                |              |                      |
| linux-aarch64     |                |              |                      |
| linux-x86_64      |                |              |                      |
