...
2. **[ethereum/execution-specs](https://github.com/ethereum/execution-specs)** - Test fixtures and vectors (the former `ethereum/execution-spec-tests` repo is archived)
   - Mainnet: `tests@v20.0.0` (Osaka + BPO1 + BPO2); Amsterdam: `tests-glamsterdam-devnet@v7.0.0`
...
https://github.com/ethereum/execution-specs/releases/download/tests-glamsterdam-devnet%40v7.0.0/fixtures_glamsterdam-devnet.tar.gz
```
