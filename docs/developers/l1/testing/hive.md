...
2. **Update execution-spec-tests version** in `.github/workflows/daily_hive_report.yaml`:

   ```yaml
   FLAGS+=" --sim.buildarg fixtures=https://github.com/ethereum/execution-spec-tests/releases/download/<version>/fixtures_develop.tar.gz"
...
3. **Update fixtures URL files**:
   ...
   ```bash
   echo "https://github.com/ethereum/execution-spec-tests/releases/download/<version>/fixtures_develop.tar.gz" > tooling/ef_tests/blockchain/.fixtures_url
   echo "https://github.com/ethereum/execution-spec-tests/releases/download/<version>/fixtures_develop.tar.gz" > tooling/ef_tests/state/.fixtures_url
   ```
