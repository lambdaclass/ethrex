...
- [L1](./developers/l1/introduction.md)
  ...
  - [DB observability](./developers/l1/db-observability.md)
...
- [Prover](./prover/prover.md)
  ...
  - [zkVM Ecosystem](./prover/zkvm/README.md)
    - [Backend Comparison](./prover/zkvm/backends.md)
    - [Patches & Precompiles](./prover/zkvm/patches.md)
    - [Optimization Status](./prover/zkvm/optimization-status.md)
