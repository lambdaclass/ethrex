...
You can enable the prover by setting `ETHREX_DEPLOYER_DEPLOY_TDX_VERIFIER=true`.
...
```sh
// cd crates/l2
make init ETHREX_DEPLOYER_DEPLOY_TDX_VERIFIER=true PROOF_COORDINATOR_ADDRESS=0.0.0.0
```
