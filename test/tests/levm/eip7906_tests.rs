//! EIP-7906: TXTRACE (0xB6) and EVENTDATACOPY (0xB7) on hegota-devnet (renumbered from 0xB5/0xB6).
//!
...
// Renumbered to 0xB6/0xB7 on hegota-devnet so EIP-8272 owns 0xB5 (RECENTROOTREFLOAD).
