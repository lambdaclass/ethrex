...
static HASH_FIRST: LazyLock<H256> = LazyLock::new(|| {
    H256::from_str("0x005e94bf632e80cde11add7d3447cd4ca93a5f2205d9874261484ae180718bd6").unwrap()
});
static HASH_SECOND: LazyLock<H256> = LazyLock::new(|| {
    H256::from_str("0x00748bacab20da9ae19dd26a33bd10bbf825e28b3de84fc8fe1d15a21645067f").unwrap()
});
