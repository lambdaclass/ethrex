...
fn add_transaction_no_broadcast_keeps_tx_out_of_broadcast_pool() {
    ...
    mempool
        .add_transaction(public_hash, public_sender, public_tx.clone(), None, None)
        .expect("public tx should land in broadcast pool");
    mempool
        .add_transaction_no_broadcast(private_hash, private_sender, private_tx.clone(), None, None)
